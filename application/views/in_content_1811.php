...
<div class="modal fade" id="subir_archivo" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-default" data-dismiss="modal">Cancelar</button>
        <button type="button" class="btn btn-primary" onclick="subir_archivo()">Subir Archivo</button>
      </div>
    </div>
  </div>
</div>
...
function menupri(){
    ...
    html+='<div class="col-md-6 col-sm-6 col-lg-3">';
    html+='<div class="mini-stat clearfix bx-shadow">';
    html+='<a href="http://puntoedu.co" target="_blank">';
    html+='<img src="./img/botones/puntoedu.png"  width="100%" height="100%"></a>';
    html+='</div></div></div>';
    $("#migas").html('');
    $("#contenedor").html(html);                   
}  
