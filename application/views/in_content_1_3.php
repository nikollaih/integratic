  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">      
      <div class="modal-body">
                <img src="./img/portada.png"  width="100%" height="100%">
      </div>
    ...
    <div class="modal-dialog"> 
        <div class="modal-content"> 
                ...
                <div class="row"> 
                    ...
                    <div class="col-md-6"> 
                        <div class="form-group"> 
                            ...
                            <input class="form-control" id="apellidos" name="apellidos" placeholder="Apelidos" type="text"> 
                        </div> 
                    </div> 
                </div> 
                <div class="row"> 
            ...
            <div class="modal-footer"> 
                ...
                <button type="button" class="btn btn-info waves-effect waves-light" onclick="creaUsuario();">Guardar</button> 
            </div>
        </form>         
        </div> 
    </div>
    ...
    <div class="modal-dialog modal-lg"> 
        <div class="modal-content"> 
            ...
            <div class="modal-body"> 
                ...
                <div class="row"> 
                    <div class="col-md-6">
                            <button type="button" class="btn btn-info waves-effect waves-light" onclick="javascript:in_asg();">Agregar</button> 
                            <button type="button" class="btn btn-info waves-effect waves-light" onclick="javascript:remover_asg();">Retirar</button>                         
                    </div> 
                    <div class="col-md-6"> 
                        <div class="form-group"> 
            ...
            <div class="modal-footer"> 
                <button type="button" class="btn btn-info waves-effect" data-dismiss="modal">Terminar</button> 
            </div>        
        </div> 
    </div>      
</div>
        ...
        <div class="modal-content"> 
            ...
            <form id="frmareas" name="frmareas" enctype="multipart/form-data">  
                <div class="row"> 
                    <div class="col-md-12"> 
                        <div class="form-group">
                            <label for="tipo" class="control-label">Tipo de Area</label>
                                <select class="form-control" id="tipo" name="tipo">
                                <option>Seleccione</option>    
                                <option value="areas">Area con asignaturas</option> 
                                </select>
                        </div>                
                    </div>                
                </div>                 
            ...
            <div class="modal-footer"> 
                <button type="button" class="btn btn-default waves-effect" data-dismiss="modal">Cerrar</button> 
                <button type="button" class="btn btn-info waves-effect" data-dismiss="modal" onclick="crearArea();">Guardar</button> 
            </div>        
        </div> 
    </div>      
</div>
...
<div class="modal fade" id="modal_materias" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog modal-md"> 
        <div class="modal-content"> 
            ...
            <div class="modal-footer"> 
                <button type="button" class="btn btn-default waves-effect" data-dismiss="modal">Cerrar</button> 
                <button type="button" class="btn btn-info waves-effect" data-dismiss="modal" onclick="crearMateria();">Guardar</button> 
            </div>        
        </div> 
    </div>      
</div>
<!-- Modal Diferentes consultas -->
<div class="modal fade" id="modal_consultas" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog modal-lg"> 
        <div class="modal-content"> 
            <div class="modal-header"> 
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button> 
...
<div class="modal fade" id="modal_proyectos" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog modal-md"> 
        <div class="modal-content"> 
            ...
            <div class="modal-footer"> 
                <button type="button" class="btn btn-default waves-effect" data-dismiss="modal">Cerrar</button> 
                <button type="button" class="btn btn-info waves-effect" data-dismiss="modal" onclick="crearProyecto();">Guardar</button> 
            </div>        
        </div> 
    </div>      
</div>
...
<div class="modal fade" id="modal_procesos" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog modal-md"> 
        <div class="modal-content"> 
            ...
            <div class="modal-footer"> 
                <button type="button" class="btn btn-default waves-effect" data-dismiss="modal">Cerrar</button> 
                <button type="button" class="btn btn-info waves-effect" data-dismiss="modal" onclick="crearProceso();">Guardar</button> 
            </div>        
        </div> 
    </div>      
</div>
    ...
    <div class="modal-dialog modal-lg"> 
        <div class="modal-content"> 
            ...
            <div class="modal-body"> 
                ...
                <div class="row"> 
                    <div class="col-md-6">
                            <button type="button" class="btn btn-info waves-effect waves-light" onclick="javascript:in_asignapro();">Agregar</button> 
                            <button type="button" class="btn btn-info waves-effect waves-light" onclick="javascript:remover_pro();">Retirar</button>                         
                    </div>                
                </div>                 
            </div>   
            <div class="modal-footer"> 
    ...
    <div class="modal-dialog modal-lg"> 
        <div class="modal-content"> 
            ...
            <div class="modal-body"> 
                ...
                <div class="row"> 
                    <div class="col-md-6">
                            <button type="button" class="btn btn-info waves-effect waves-light" onclick="javascript:in_asignaproc();">Agregar</button> 
                            <button type="button" class="btn btn-info waves-effect waves-light" onclick="javascript:remover_proc();">Retirar</button>                         
                    </div>                
                </div>                 
            </div>   
            <div class="modal-footer"> 
...
<div class="modal fade" id="modal_menupri" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog modal-md"> 
        <div class="modal-content"> 
            <div class="modal-header"> 
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button> 
                <h4 class="modal-title">Configuración Menú Principal</h4> 
            </div> 
            <div class="modal-body"> 
            <form id="frm_menu" name="frm_menu" enctype="multipart/form-data">  
                ...
                <div class="row"> 
                    <div class="col-md-6"> 
                        <div class="form-group">
                            <label for="nivel" class="control-label">Ingrese Tipo de Nivel</label>
                            <select class="form-control" id="nivel" name="nivel" onchange="in_subnivel();">
                    ...
                    <div class="col-md-6"> 
                        <div class="form-group">
                            <label for="subnivel" class="control-label">Ingrese Nivel Principal</label>
                            <select class="form-control" id="subnivel" name="subnivel" disabled>
                                <option>Seleccione Nivel Principal</option>    
                                <option value="1">Principal</option> 
                                <option value="2">Submenú</option> 
                                </select>
                        </div>
            ...
            <div class="modal-footer"> 
                <button type="button" class="btn btn-default waves-effect" data-dismiss="modal">Cerrar</button> 
                <button type="button" class="btn btn-default waves-effect" data-dismiss="modal" onclick="consultas('menupri');">Consultar</button> 
                <button type="button" class="btn btn-info waves-effect" data-dismiss="modal" onclick="crearMenu();">Guardar</button> 
            </div>        
        </div> 
    </div>      
</div>
...
function menupri(){
    ...
    html+="<div class='col-md-6 col-sm-6 col-lg-3'>"; 
    html+='<div class="mini-stat clearfix bx-shadow">';
    html+='<a href="./principal/aprender" target="_blank"><img src="./img/botones/aprender.png" width="100%" height="100%"></a>';
    html+='</div></div>';
    html+='<div class="col-md-6 col-sm-6 col-lg-3">';
    html+='<div class="mini-stat clearfix bx-shadow">';
    html+='<a href="javascript:areas()"><img src="./img/botones/areas.png"  width="100%" height="100%"></a>';
    html+='</div></div>';   
    html+='<div class="col-md-6 col-sm-6 col-lg-3">';
    html+='<div class="mini-stat clearfix bx-shadow">';
    html+='<a href="../moodle" target="_blank"><img src="./img/botones/moodlegs.png"  width="100%" height="100%"></a>';
    html+='</div></div>';          
    html+='<div class="col-md-6 col-sm-6 col-lg-3">';
    html+='<div class="mini-stat clearfix bx-shadow">';
    html+='<a href="./principal/project" target="_blank"><img src="./img/botones/claseweb.png"  width="100%" height="100%"></a>';
    html+='</div></div>';      
    html+='<div class="col-md-6 col-sm-6 col-lg-3">';
    html+='<div class="mini-stat clearfix bx-shadow">';
    html+='<a href="./principal/wikipedia" target="_blank"><img src="./img/botones/wiki.png"  width="100%" height="100%"></a>';
    html+='</div></div>'; 
    html+='<div class="col-md-6 col-sm-6 col-lg-3">';
    html+='<div class="mini-stat clearfix bx-shadow">';
    html+='<a href="./principal/geogebra" target="_blank"><img src="./img/botones/geogebra.png"  width="100%" height="100%"></a>';
    html+='</div></div>'; 
    html+='<div class="col-md-6 col-sm-6 col-lg-3">';
    html+='<div class="mini-stat clearfix bx-shadow">';
    html+='<a href="./principal/retomatic" target="_blank"><img src="./img/botones/retomatic.png"  width="100%" height="100%"></a>';
    html+='</div></div>'; 
    html+='<div class="col-md-6 col-sm-6 col-lg-3">';
    html+='<div class="mini-stat clearfix bx-shadow">';
    html+='<a href="./principal/periodico" target="_blank"><img src="./img/botones/periodico.png"  width="100%" height="100%"></a>';
    html+='</div></div>';         
    html+='<div class="col-md-6 col-sm-6 col-lg-3">';
    html+='<div class="mini-stat clearfix bx-shadow">';
    html+='<a href="javascript:listado('+"'raiz'"+','+"'dpensar'"+','+"'dpensar'"+')"><img src="./img/botones/dpensar.png"  width="100%" height="100%"></a>';
    html+='</div></div>';      
    html+='<div class="col-md-6 col-sm-6 col-lg-3">';
    html+='<div class="mini-stat clearfix bx-shadow">';
    html+='<a href="./principal/fisica/index.htm" target="_blank"><img src="./img/botones/fisicaor.png"  width="100%" height="100%"></a>';
    html+='</div></div>';      
    html+='<div class="col-md-6 col-sm-6 col-lg-3">';
    html+='<div class="mini-stat clearfix bx-shadow">';
    html+='<a href="javascript:listado('+"'raiz'"+','+"'semilla'"+','+"'semilla'"+')"><img src="./img/botones/semilla.png"  width="100%" height="100%"></a>';
    html+='</div></div>';
    html+='<div class="col-md-6 col-sm-6 col-lg-3">';
    html+='<div class="mini-stat clearfix bx-shadow">';
    html+='<a href="javascript:listado('+"'raiz'"+','+"'plugins'"+','+"'plugins'"+')">';
    html+='<img src="./img/botones/plugins.png"  width="100%" height="100%"></a>';
    html+='</div></div>';
    html+='<div class="col-md-6 col-sm-6 col-lg-3">';
    html+='<div class="mini-stat clearfix bx-shadow">';
    html+='<a href="javascript:lab()"><img src="./img/botones/virtualab.png"  width="100%" height="100%"></a>';
    html+='</div></div>';      
    html+='<div class="col-md-6 col-sm-6 col-lg-3">';
    html+='<div class="mini-stat clearfix bx-shadow">';
    html+='<a href="javascript:listado('+"'raiz'"+','+"'animaingles'"+','+"'animaingles'"+')">';
    html+='<img src="./img/botones/animaciones.png"  width="100%" height="100%"></a>';
    html+='</div></div>';     
    html+='<div class="col-md-6 col-sm-6 col-lg-3">';
    html+='<div class="mini-stat clearfix bx-shadow">';
    html+='<a href="javascript:listado('+"'raiz'"+','+"'bibliotecags'"+','+"'bibliotecags'"+')">';
    html+='<img src="./img/botones/biblioteca.png"  width="100%" height="100%"></a>';
    html+='</div></div>';     
    html+='<div class="col-md-6 col-sm-6 col-lg-3">';
    html+='<div class="mini-stat clearfix bx-shadow">';
    html+='<a href="./principal/cidead/edad/index.htm" target="_blank">';
    html+='<img src="./img/botones/cidead.png"  width="100%" height="100%"></a>';
    html+='</div></div>';     
    html+='<div class="col-md-6 col-sm-6 col-lg-3">';
    html+='<div class="mini-stat clearfix bx-shadow">';
    html+='<a href="javascript:listado('+"'raiz'"+','+"'mecanico'"+','+"'mecanico'"+')">';
    html+='<img src="./img/botones/universo.png"  width="100%" height="100%"></a>';
    html+='</div></div>';                    
    html+='<div class="col-md-6 col-sm-6 col-lg-3">';
    html+='<div class="mini-stat clearfix bx-shadow">';
    html+='<a href="javascript:listado('+"'raiz'"+','+"'saber'"+','+"'saber'"+')">';
    html+='<img src="./img/botones/saber.png"  width="100%" height="100%"></a>';
    html+='</div></div>';       
    html+='<div class="col-md-6 col-sm-6 col-lg-3">';
    html+='<div class="mini-stat clearfix bx-shadow">';
    html+='<a href="javascript:listado('+"'raiz'"+','+"'animat'"+','+"'animat'"+')">';
    html+='<img src="./img/botones/animat.png"  width="100%" height="100%"></a>';
    html+='</div></div>';           
    html+='<div class="col-md-6 col-sm-6 col-lg-3">';
    html+='<div class="mini-stat clearfix bx-shadow">';
    html+='<a href="javascript:listado('+"'raiz'"+','+"'reacciones'"+','+"'reacciones'"+')">';
    html+='<img src="./img/botones/reacciones.png"  width="100%" height="100%"></a>';
    html+='</div></div>';     
    html+='<div class="col-md-6 col-sm-6 col-lg-3">';
    html+='<div class="mini-stat clearfix bx-shadow">';
    html+='<a href="javascript:listado('+"'raiz'"+','+"'problematic'"+','+"'problematic'"+')">';
    html+='<img src="./img/botones/problematic.png"  width="100%" height="100%"></a>';
    html+='</div></div>';    
    html+='<div class="col-md-6 col-sm-6 col-lg-3">';
    html+='<div class="mini-stat clearfix bx-shadow">';
    html+='<a href="./principal/tablap/index.htm" target="_blank">';
    html+='<img src="./img/botones/tablap.png"  width="100%" height="100%"></a>';
    html+='</div></div>'; 
    html+='<div class="col-md-6 col-sm-6 col-lg-3">';
    html+='<div class="mini-stat clearfix bx-shadow">';
    html+='<a href="javascript:listado('+"'raiz'"+','+"'materiales'"+','+"'materiales'"+')">';
    html+='<img src="./img/botones/materiales.png"  width="100%" height="100%"></a>';
    html+='</div></div>';      
    html+='<div class="col-md-6 col-sm-6 col-lg-3">';
    html+='<div class="mini-stat clearfix bx-shadow">';
    html+='<a href="javascript:listado('+"'raiz'"+','+"'artehistoria'"+','+"'artehistoria'"+')">';
    html+='<img src="./img/botones/artehistoria.png"  width="100%" height="100%"></a>';
    html+='</div></div>';          
    html+='<div class="col-md-6 col-sm-6 col-lg-3">';
    html+='<div class="mini-stat clearfix bx-shadow">';
    html+='<a href="../principal/limesurvey" target="_blank">';
    html+='<img src="./img/botones/limesurvey.png"  width="100%" height="100%"></a>';
    html+='</div></div>';      
    html+='<div class="col-md-6 col-sm-6 col-lg-3">';
    html+='<div class="mini-stat clearfix bx-shadow">';
    html+='<a href="./principal/lorenzo" target="_blank">';
    html+='<img src="./img/botones/lorenzo.png"  width="100%" height="100%"></a>';
    html+='</div></div>';             
    html+='<div class="col-md-6 col-sm-6 col-lg-3">';
    html+='<div class="mini-stat clearfix bx-shadow">';
    html+='<a href="javascript:listado('+"'raiz'"+','+"'docpta'"+','+"'docpta'"+')">';
    html+='<img src="./img/botones/docpta.png"  width="100%" height="100%"></a>';
    html+='</div></div>';            
    html+='<div class="col-md-6 col-sm-6 col-lg-3">';
    html+='<div class="mini-stat clearfix bx-shadow">';
    html+='<a href="./principal/simuladorpc" target="_blank">';
    html+='<img src="./img/botones/ensapc.png"  width="100%" height="100%"></a>';
    html+='</div></div>';
    html+='<div class="col-md-6 col-sm-6 col-lg-3">';
    html+='<div class="mini-stat clearfix bx-shadow">';
    html+='<a href="javascript:descartes()">';
    html+='<img src="./img/botones/pro_descartes.png"  width="100%" height="100%"></a>';
    html+='</div></div>'; 
    html+='<div class="col-md-6 col-sm-6 col-lg-3">';
    html+='<div class="mini-stat clearfix bx-shadow">';
    html+='<a href="javascript:listado('+"'raiz'"+','+"'academiaplay'"+','+"'academiaplay'"+')">';
    html+='<img src="./img/botones/academia.png"  width="100%" height="100%"></a>';
    html+='</div></div>'; 
    html+='<div class="col-md-6 col-sm-6 col-lg-3">';
    html+='<div class="mini-stat clearfix bx-shadow">';
    html+='<a href="./principal/biblia/index.htm" target="_blank">';
    html+='<img src="./img/botones/biblia.png"  width="100%" height="100%"></a>';
    html+='</div></div>';        
    html+='<div class="col-md-6 col-sm-6 col-lg-3">';
    html+='<div class="mini-stat clearfix bx-shadow">';
    html+='<a href="javascript:listado('+"'raiz'"+','+"'verdetopia'"+','+"'verdetopia'"+')">';
    html+='<img src="./img/botones/verdetopia.png"  width="100%" height="100%"></a>';
    html+='</div></div>';    
    html+='<div class="col-md-6 col-sm-6 col-lg-3">';
    html+='<div class="mini-stat clearfix bx-shadow">';
    html+='<a href="javascript:listado('+"'raiz'"+','+"'viviendopcc'"+','+"'viviendopcc'"+')">';
    html+='<img src="./img/botones/viviendopcc.png"  width="100%" height="100%"></a>';
    html+='</div></div>'; 
    html+='<div class="col-md-6 col-sm-6 col-lg-3">';
    html+='<div class="mini-stat clearfix bx-shadow">';
    html+='<a href="javascript:listado('+"'raiz'"+','+"'seguimiento'"+','+"'seguimiento'"+')">';
    html+='<img src="./img/botones/seguimiento.png"  width="100%" height="100%"></a>';
    html+='</div></div>';   
    html+='<div class="col-md-6 col-sm-6 col-lg-3">';
    html+='<div class="mini-stat clearfix bx-shadow">';
    html+='<a href="https://docs.google.com/forms/d/e/1FAIpQLScUwCOA0uVryV6WF4Bb8jCCzGIJGo4LySwCxIK8rz9yedYlNw/viewform?usp=sf_link" target="_blank">  ';
    html+='<img src="./img/botones/tabaquismo.png"  width="100%" height="100%"></a>';
    html+='</div></div>';                     
    html+='</div>';
    $("#migas").html('');
    $("#contenedor").html(html);                   
...
function listado(tipo,carpeta,materia,grupo){   
...
function cfg_planeacion(){         
    ...
    var rol=document.getElementById("rol").value;
    cambio_menu();
    listar_planeacion(document.getElementById("ced").value);
}
...
function listar_comunica(){
    ...
    else{html+="<a href='javascript:listado(\"raiz\",\"documentos\",\"documentos\")'>";}
...
function listar_planeacion(){
    html='<div class="panel panel-primary">';        
    html=html+'<div class="panel-heading text-capitalize"><b>Planeación Institucional</b></div>';
    html=html+'<div class="panel-body">';                          
    html=html+"<div class='col-md-6 col-sm-6 col-lg-3'>";
    html=html+"<div class='mini-stat clearfix bx-shadow'>";
    html=html+"<a href='javascript:listardoc(\"raiz\",\"plan_area\",\"plan_area\")'>";
    html=html+"<img src='./img/botones/plan_area/plan_area.png' width='100%' height='100%'></a></div></div>";   
    html=html+"<div class='col-md-6 col-sm-6 col-lg-3'>";
    html=html+"<div class='mini-stat clearfix bx-shadow'>";
    html=html+"<a href='javascript:listardoc(\"raiz\",\"picc\",\"picc\")'>";
    html=html+"<img src='./img/botones/picc/picc.png' width='100%' height='100%'></a></div></div>";  
    html=html+"</div></div>";     
    html=html+'<div id="contenido"><div class="panel-body"><div id="listacon"></div></div></div>';
...
var rol=document.getElementById("rol").value;    
    if (rol!=='super'){ 
        ...
        html+="<i><img src='./img/iconos/asignacion.png' width='40' height='40'></i><span>Asignación</span></a></li>";
        html+="<li><a href='javascript:cfg_proyectos();' class='waves-effect'>";
        html+="<i><img src='./img/iconos/proyectos.png' width='40' height='40'></i><span>Proyectos</span></a></li>";    
        html+="<li><a href='javascript:cfg_comunicacion();' class='waves-effect'>";
        html+="<i><img src='./img/iconos/comunicacion.png' width='50' height='40'></i><span>Comunicación</span></a></li>";    
        html+="<li><a href='javascript:cfg_planeacion();' class='waves-effect'>";
        html+="<i><img src='./img/iconos/planeacion.png' width='50' height='40'></i><span>Planeación</span></a></li>"; 
        html+="<li><a href='javascript:cfg_cambio_clave();' class='waves-effect'>";
        html+="<i><img src='./img/iconos/password.png' width='50' height='40'></i><span>Cambio Clave</span></a></li>";             
        html+="<li><a href='index.php'>";
        html+="<i><img src='./img/iconos/salir.png' width='50' height='30'></i><span>Cerrar Sesión</span></a></li>";  
        html+="</ul>";
...
function administrar(){
        ...
        //html=html+"<div class='col-md-2 col-sm-2 col-lg-2'><div class='mini-stat clearfix bx-shadow'></div></div>";        
        html=html+"<div class='col-md-3 col-sm-3 col-lg-3'>";
        html=html+"<div class='mini-stat clearfix bx-shadow'>";
        ...
        html=html+"<img src='./img/botones/menu/cfg_menu.png' width='100%' height='100%'></a></div></div>";           
        html+="</div></div>";   
        html=html+'<div id="contenido"><div class="panel-body"><div id="listacon"></div></div></div>';
        $("#contenedor").html(html);   
        ...
        html+="<i><img src='./img/iconos/manual.png' width='60' height='40'></i><span>Manual Usuario</span></a></li>";          
        html+="<li><a href='index.php'>";
        html+="<i><img src='./img/iconos/salir.png' width='50' height='30'></i><span>Cerrar Sesión</span></a></li>";         
        html+="</ul>";
        $("#sidebar-menu").html(html); 
...
var html='<div class="panel panel-primary">';
    ...
    html+='<select class="form-control" name="materia_acti" id="materia_acti" onchange="javascript:mostrar_acti();">';
...
function mostrar_materias(){ 
  ...
  if(grado){
    ...
    html='<select class="form-control" name="materia" id="materia" onclick="javascript:mostrar_conte();">';
...
function remover_asg(){
    ...
    $.ajax({
            url:'<?=site_url();?>/asignacion/bo_asigna',
            type:'POST',
            datatype:'json',
...
function con_areas(){
                    ...
                    var html='<table class="table table-bordered table-hover">';
                      ...
                      if(registros.length>0){ 
                          for (i=0; i<registros.length; i++) { 
                                    ...
                                    html+='<td><a href="javascript:borrarArea(this);" onclick="borrarArea(this)">';
                                    html+='<img src="<?=base_url();?>img/delete.png" width="20" height="20"/></a></td>';
                                    html+='<td><a href="javascript:editarArea(this);" onclick="editarArea(this)">';
    ...
    pie='<button type="button" class="btn btn-info waves-effect" data-dismiss="modal">Terminar</button>';      
            ...
            success:function(respuesta){
                var registros = eval(respuesta);
                    var html='<table class="table table-bordered table-hover">';
                        html+='<thead><tr style="background-color: #F6CED8">';
                        html+='<th width="20%">Código</th>';
                        html+='<th width="60%">Materia</th>';
                        html+='<th width="60%">Grado</th>';
                        html+='<th width="10%">Eliminar</th>';
                        html+='<th width="10%">Editar</th>';            
                        html+="</tr></thead>";
                      if(registros.length>0){ 
                          for (i=0; i<registros.length; i++) { 
                                    ...
                                    html+='<td><a href="javascript:borrarMateria(this);" onclick="borrarMateria(this)">';
                                    html+='<img src="<?=base_url();?>img/delete.png" width="20" height="20"/></a></td>';
                                    html+='<td><a href="javascript:editarMateria(this);" onclick="editarMateria(this)">';
                                    html+='<img src="<?=base_url();?>img/editar.png" width="20" height="20"/></a></td>';
                                    html+='</tr>';
                          }     
                   }                
                    ...
                    var html='<table class="table table-bordered table-hover">';
                      ...
                      if(registros.length>0){ 
                          for (i=0; i<registros.length; i++) { 
                                    ...
                                    html+='<td><a href="javascript:borrarProceso(this);" onclick="borrarProceso(this)">';
                                    html+='<img src="<?=base_url();?>img/delete.png" width="20" height="20"/></a></td>';
                                    html+='<td><a href="javascript:editarProceso(this);" onclick="editarProceso(this)">';
                                    html+='<img src="<?=base_url();?>img/editar.png" width="20" height="20"/></a></td>';
                                    html+='</tr>';
                          }     
                   }                
            ...
            success:function(respuesta){
                var registros = eval(respuesta);
                    var html='<table class="table table-bordered table-hover">';
                        html+='<thead><tr style="background-color: #F6CED8">';
                        html+='<th width="20%">Código</th>';
                        html+='<th width="60%">Nombre Completo</th>';
                        html+='<th width="60%">email</th>';
                        html+='<th width="60%">rol</th>';
                        html+='<th width="10%">Eliminar</th>';
                        html+='<th width="10%">Editar</th>';            
                        html+="</tr></thead>";
                      if(registros.length>0){ 
                          for (i=0; i<registros.length; i++) { 
                                    ...
                                    html+='<td><a href="javascript:borrarUsr(this);" onclick="borrarUsr(this)">';
                                    html+='<img src="<?=base_url();?>img/delete.png" width="20" height="20"/></a></td>';
                                    html+='<td><a href="javascript:editarUsr(this);" onclick="editarUsr(this)">';
                                    html+='<img src="<?=base_url();?>img/editar.png" width="20" height="20"/></a></td>';
                                    html+='</tr>';
                          }     
                   }                
...
function consu_menu(){
    $.ajax({
            url:'<?=site_url();?>/consultas/con_menupri',
            type:'POST',
            cache:false,
            async:false,
            dataType:'json',
            success:function(respuesta){
                var registros = eval(respuesta);
                    var html='<table class="table table-bordered table-hover">';
                        html+='<thead><tr style="background-color: #F6CED8">';
                        html+='<th width="5%">Código</th>';
                        html+='<th width="60%">Nombre</th>';
                        html+='<th width="10%">Tipo</th>';
                        html+='<th width="20%">Enlace</th>';  
                        html+='<th width="10%">Eliminar</th>';
                        html+='<th width="10%">Editar</th>';            
                        html+="</tr></thead>";
                      if(registros.length>0){ 
                          for (i=0; i<registros.length; i++) { 
                                    ...
                                    html+='<td><a href="javascript:borrarMateria(this);" onclick="borrarMenu(this)">';
                                    html+='<img src="<?=base_url();?>img/delete.png" width="20" height="20"/></a></td>';
                                    html+='<td><a href="javascript:editarMateria(this);" onclick="editarMenu(this)">';
                                    html+='<img src="<?=base_url();?>img/editar.png" width="20" height="20"/></a></td>';
                                    html+='</tr>';
                          }     
                   }                
...
var campo = nodosEnTr[0].textContent;
 $.ajax({
    url:"<?=site_url();?>/consultas/con_menup/"+campo,
    type:"POST",
    success:function(respuesta){
       var registros = eval(respuesta); 
         for (i=0; i<registros.length; i++) { 
            html="<form id='frmeditar' name='frmeditar' enctype='multipart/form-data'>"+         
                    ...
                    "<div class='input-group'>"+  
                    "<input class='form-control' type='text' id='ucodmat' name='ucodigo' value='"+registros[i]["id"]+"'  placeholder='Código de Area' maxlength='5' readonly>"+
                    "<span class='input-group-addon'><i class='fa fa-check'></i></span></div>"+
                    "<label for='desc'>Nombre</label>"+     
                    "<div class='input-group'>"+               
                    "<input class='form-control' type='text' id='unommat' name='unombre' value='"+registros[i]["nombre"]+"' placeholder='Nombre' maxlength='50'>"+
                    "<span class='input-group-addon'><i class='fa fa-check'></i></span></div>"+
                    "<label for='desc'>Nivel</label>"+
                    "<div class='input-group'>"+               
                    "<input class='form-control' type='text' id='ugramat' name='univel' value='"+registros[i]["nivel"]+"' placeholder='Nivel' maxlength='50'>"+
                    "<span class='input-group-addon'><i class='fa fa-check'></i></span></div>"+   
                    "<label for='desc'>Nivel Superior</label>"+  
                    "<div class='input-group'>"+               
                    "<input class='form-control' type='text' id='ugramat' name='univelsup' value='"+registros[i]["nivel_sup"]+"' placeholder='Nombre de Area' maxlength='50'>"+
                    "<span class='input-group-addon'><i class='fa fa-check'></i></span></div>"+
                    "<label for='desc'>Orden</label>"+  
                    "<div class='input-group'>"+               
                    "<input class='form-control' type='text' id='ugramat' name='univelsup' value='"+registros[i]["orden"]+"' placeholder='Orden' maxlength='50'>"+
                    "<span class='input-group-addon'><i class='fa fa-check'></i></span></div>"+                    
                    "<label for='desc'>Tipo</label>"+  
                    "<div class='input-group'>"+               
                    "<input class='form-control' type='text' id='ugramat' name='univelsup' value='"+registros[i]["tipo"]+"' placeholder='Tipo' maxlength='50'>"+
                    "<span class='input-group-addon'><i class='fa fa-check'></i></span></div>"+                    
                    "<label for='desc'>Parámetro/Enlace</label>"+  
                    "<div class='input-group'>"+               
                    "<input class='form-control' type='text' id='ugramat' name='univelsup' value='"+registros[i]["enlace"]+"' placeholder='Parámetro' maxlength='50'>"+
                    "<span class='input-group-addon'><i class='fa fa-check'></i></span></div>"+                                              
                    "<label for='uicomat'>Cambiar Imagen</label>"+                                
    ...
    error:function(){alert("No hay Registros!");}        
     ...
     function updateUsr(){alert(document.getElementById("ucod").value);
...
function copiar_actividades(){  
/* 
            require('lib/pclzip.lib.php');
            $zip = new PclZip('actividades.zip');
            ...
            $enlace = "./principal/areas/actividades/ingles 9c/admin.png";//$_GET['id'];
