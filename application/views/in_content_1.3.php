...
function menupri(){
    ...
    html+='<div class="col-md-6 col-sm-6 col-lg-3">';
    html+='<div class="mini-stat clearfix bx-shadow">';
    html+='<a href="./principal/project" target="_blank"><img src="./img/botones/bilingue.png"  width="100%" height="100%"></a>';
    html+='</div></div>';      
    html+='<div class="col-md-6 col-sm-6 col-lg-3">';
    html+='<div class="mini-stat clearfix bx-shadow">';
    ...
    html+='<div class="col-md-6 col-sm-6 col-lg-3">';
    html+='<div class="mini-stat clearfix bx-shadow">';
    html+='<a href="./principal/claseweb" target="_blank"><img src="./img/botones/claseweb.png"  width="100%" height="100%"></a>';
    html+='</div></div>';     
    html+='<div class="col-md-6 col-sm-6 col-lg-3">';
    html+='<div class="mini-stat clearfix bx-shadow">';
