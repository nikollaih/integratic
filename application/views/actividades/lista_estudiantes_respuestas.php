...
?>
        <tr>
            ...
            <td class="text-center" style="width:60px;"><?= ($e["respuesta"] != null) ? '<input id="calificacion-respuesta-'.$e["respuesta"]["id_respuestas_actividades"].'" readonly="readonly" class="input no-calificar text-center" type="number" value="'.$e["respuesta"]["calificacion"] .'"/>' : "" ?></td>
