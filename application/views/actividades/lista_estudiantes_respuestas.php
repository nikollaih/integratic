...
?>
        <tr>
            ...
            <td class="text-center" style="width:60px;"><?= ($e["respuesta"] != null) ? '<textarea id="calificacion-respuesta-notas-'.$e["respuesta"]["id_respuestas_actividades"].'" readonly="readonly" class="modificar-calificacion-respuesta-'.$e["respuesta"]["id_respuestas_actividades"].' input no-calificar">'.$e["respuesta"]["docente_notas"] .'</textarea>' : "" ?></td>
            <td class="text-center">
                <?= ($e["respuesta"] != null) ? "<a href='".base_url()."uploads/actividades/respuestas/".$e["respuesta"]["url_archivo"]."' target='_blank'>Ver</a>" : "" ?>
            </td>
            <td class="text-center" style="width:60px;"><?= ($e["respuesta"] != null) ? '<input id="calificacion-respuesta-nota-'.$e["respuesta"]["id_respuestas_actividades"].'" readonly="readonly" class="modificar-calificacion-respuesta-'.$e["respuesta"]["id_respuestas_actividades"].' input no-calificar text-center" type="number" value="'.$e["respuesta"]["calificacion"] .'"/>' : "1" ?></td>
            <td class="text-center">
