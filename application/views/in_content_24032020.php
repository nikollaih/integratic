                    ...
                    html=html+'<div class="panel-body">'; 
                      if(registros.length>0){ 
                          for (i=0; i<registros.length; i++) { 
                            ...
                            html=html+"<div class='col-md-6 col-sm-6 col-lg-3'>";
                            html=html+"<div class='mini-stat clearfix bx-shadow'>";
                            html=html+"<a href='javascript:listado(\""+registros[i]["tipo"]+"\",\""+registros[i]["enlace"]+"\",\""+registros[i]["enlace"]+"\",\""+registros[i]["enlace"]+"\",\""+registros[i]["descripcion"]+"\")'>";
...
function administrar(){
        ...
        html+="<i><img src='./img/iconos/manual.png' width='50' height='50'></i><span>Manual Usuario</span></a></li>";          
        html+="<li><a href='index.php'>";
        html+="<i><img src='./img/iconos/cerrar.png' width='50' height='50'></i><span>Cerrar Sesión</span></a></li>";         
        html+="</ul>";
        $("#sidebar-menu").html(html); 
