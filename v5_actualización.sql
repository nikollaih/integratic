...
INSERT INTO `caracterizacion_estudiantes_preguntas` (`id`, `pregunta`, `titulo_excel`, `tipo_etiqueta`, `tipo_input`, `placeholder`, `es_multiple`, `opciones`, `tiene_otro`, `es_obligatoria`, `orden`, `filtro`, `categoria`) VALUES
    ...
    (28, '¿El o la estudiante pertenece a “Renta Ciudadana” anteriormente “Familias en Acción”?', 'Renta ciudadana', 'select', NULL, NULL, 0, 'a:2:{i:0;s:3:\"Si.\";i:1;s:3:\"No.\";}', 0, 1, 23, 1, 2),
    (29, '¿El o la estudiante es beneficiario(a) del Programa de Alimentación Escolar \"PAE\"? ', 'Estrategía PAE', 'select', NULL, NULL, 0, 'a:2:{i:0;s:3:\"Si.\";i:1;s:3:\"No.\";}', 0, 1, 24, 1, 2),
    (30, 'El o la estudiante vive en Zona:', 'Ubicación', 'select', NULL, NULL, 0, 'a:2:{i:0;s:22:\"Rural (zona de campo).\";i:1;s:24:\"Urbana (zona de ciudad).\";}', 0, 1, 16, 1, 2),
    (31, '¿Cuál es el estrato socioeconómico (verificar con recibos públicos) del o la estudiante?', 'Estrato', 'select', NULL, NULL, 0, 'a:6:{i:0;s:14:\"1 (Bajo-bajo).\";i:1;s:9:\"2 (Bajo).\";i:2;s:15:\"3 (Medio-bajo).\";i:3;s:10:\"4 (Medio).\";i:4;s:15:\"5 (Medio-Alto).\";i:5;s:9:\"6 (Alto).\";}', 0, 1, 17, 1, 2),
    (32, '¿Cuál de los siguientes servicios, el o la estudiante tiene en su casa? Selecciona todas las opciones que considere, puede marcar más de una respuesta.', 'Servicios', 'checkbox', NULL, NULL, 1, 'a:6:{i:0;s:5:\"Agua.\";i:1;s:9:\"Energía.\";i:2;s:9:\"Internet.\";i:3;s:17:\"Gas domiciliario.\";i:4;s:10:\"Teléfono.\";i:5;s:24:\"Recolección de basuras.\";}', 0, 1, 18, 1, 2),
    (33, '¿Cuál de los siguientes equipos tecnológicos, el o la estudiante tiene en su casa? Selecciona todas las opciones que considere, puede marcar más de una respuesta.', 'Equipo tecnológico', 'checkbox', NULL, NULL, 1, 'a:4:{i:0;s:11:\"Computador.\";i:1;s:7:\"Tablet.\";i:2;s:35:\"Celular smartphone de uso personal.\";i:3;s:35:\"Celular smartphone de uso familiar.\";}', 1, 1, 19, 1, 2),
    (34, '¿Cuál es la posibilidad de conectividad que el o la estudiante tiene?', 'Conectividad', 'select', NULL, NULL, 0, 'a:4:{i:0;s:31:\"Internet como servicio mensual.\";i:1;s:14:\"Plan de datos.\";i:2;s:9:\"Recargas.\";i:3;s:47:\"No cuenta con esta posibilidad de conectividad.\";}', 0, 1, 22, 1, 2),
    (35, '¿Cuál es la dirección de la casa del o la estudiante?', 'Dirección', 'input', 'text', NULL, 0, NULL, 0, 1, 15, 0, 2),
    (36, '¿Cuál es el número telefónico del o la estudiante?', 'Teléfono', 'input', 'number', NULL, 0, NULL, 0, 1, 14, 0, 2),
    ...
    (45, '¿El o la estudiante pertenece a alguno de los siguientes grupos?', 'Grupos', 'select', NULL, NULL, 0, 'a:6:{i:0;s:11:\"Juan XXIII.\";i:1;s:7:\"Pronic.\";i:2;s:5:\"ICBF.\";i:3;s:8:\"Abrazar.\";i:4;s:11:\"Cultivarte.\";i:5;s:39:\"No pertenece a ninguno de estos grupos.\";}', 0, 1, 25, 1, 2),
    ...
    (60, 'Si pertenece a la población desplazada, por favor, indique el lugar donde ocurrió el desplazamiento, de lo contrario escriba \"No aplica\".', 'lugar donde ocurrió el desplazamiento', 'input', 'text', NULL, 0, NULL, 0, 1, 12, 0, 2),
    (61, 'Si el equipo tecnológico con el que cuenta no se encuentra entre la lista especifique cual es, de lo contrario escriba \"No aplica\".', 'Otros equipos tecnológicos', 'input', 'text', NULL, 0, NULL, 0, 1, 20, 0, 2),
    ...
    (63, '¿El o la estudiante tiene alguna medida de protección o pertenece al sistema de responsabilidad penal adolescente?', 'Medida de protección', 'select', NULL, NULL, 0, 'a:2:{i:0;s:3:\"Si.\";i:1;s:3:\"No.\";}', 0, 1, 27, 0, 2),
